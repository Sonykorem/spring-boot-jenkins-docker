...
public class CouponController {
	@Autowired
	private CouponService couponService; // @RequestMapping("/coupons/{couponId}")
...
// @RequestMapping("/coupons")
	...
	@GetMapping("/coupons/{couponCode}/{expDate}")
   public ResponseEntity<List<CouponDto>> getByCouponCodeAndexpDate(@PathVariable String couponCode,@PathVariable String ExpDate) {
   return new ResponseEntity<List<CouponDto>>(
   couponService.getByCouponCodeAndExpDate(couponCode, ExpDate), HttpStatus.OK);
}
}
